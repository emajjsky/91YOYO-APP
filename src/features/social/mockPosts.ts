...
const postSeeds: PostSeed[] = [
  ...
  {
    id: 'post-history-indiana-contest', authorId: 'user-tao', content: '旧赛场的两张现场照记录了 2008 年参赛者在后台热身与交流的场景。', category: 'contest', styleTags: ['1A'], hashtags: ['#赛事影像', '#悠悠球历史'], createdAt: '2026-09-02T10:20:00.000Z', media: images('images-002', { uri: imageAssets.contestOne, aspectRatio: 1.5, alt: '悠悠球比赛现场选手动作照片' }, { uri: imageAssets.contestTwo, aspectRatio: 1.5, alt: '同场比赛的另一张现场照片' }), engagement: [2430, 164, 510, 68200], visibility: 'public',
  },
  {
  ...
  {
    id: 'post-history-contest-spacing', authorId: 'user-nora', content: '从历史照片到今天的赛场，观众离动作更近了，选手也更需要控制空间。', category: 'event_news', styleTags: ['1A', '4A'], hashtags: ['#悠悠球历史', '#赛场观察'], createdAt: '2026-08-03T08:35:00.000Z', media: images('images-012', { uri: imageAssets.history, aspectRatio: 0.66, alt: '1970 年悠悠球冠军比赛黑白照片' }, { uri: imageAssets.contestOne, aspectRatio: 1.5, alt: '现代悠悠球比赛现场照片' }), engagement: [1280, 102, 231, 39200], visibility: 'public',
  },
  {
